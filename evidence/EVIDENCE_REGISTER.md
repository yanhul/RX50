...
| EV-52 | C-20b is a verified interface incompatibility when CD4067 is at 5 V: using EV-09's 3.3 V STM32 operating point and EV-08's source-bounded VOH(min)=VDD−0.4 V condition gives 2.9 V, below CD4067 VIH requirement 3.5 V | `evidence/EVIDENCE_REGISTER.md` EV-08/EV-09/EV-12; `RX50_G4_G5_CLOSURE_AUDIT.md` S-14/S-15 | VERIFIED; owner decision required; no option selected |
