...
| EV-08 | STM32F103 output levels | VOH = VDD-0.4 for CMOS port; output-voltage table applies at 2.7 V < VDD < 3.6 V; VOL row NEEDS RECHECK | DS5319 Rev 20 Table 37 §5.3.13 | VERIFIED / partial |
